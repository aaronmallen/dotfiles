...
command -v git-lfs   >/dev/null && mkdir -p ${XDG_CONFIG_HOME}/git-lfs   && git lfs completion zsh > ${XDG_CONFIG_HOME}/git-lfs/_git-lfs
...
command -v mas       >/dev/null && mkdir -p ${XDG_CONFIG_HOME}/mas       && mas --generate-completion-script zsh > ${XDG_CONFIG_HOME}/mas/_mas
...
command -v tailscale >/dev/null && mkdir -p ${XDG_CONFIG_HOME}/tailscale && tailscale completion zsh > ${XDG_CONFIG_HOME}/tailscale/_tailscale
